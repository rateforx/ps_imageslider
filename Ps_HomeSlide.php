...
class Ps_HomeSlide extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields'    => array(
            ...
            'imageMobile' => array( 'type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isCleanHtml', 'size' => 255 ),
        )
    );
    ...
    public function delete ()
    {
        ...
        foreach ( $images as $image ) {
            if ( preg_match( '/sample/', $image ) === 0 ) {
                ...
                if ( $image && file_exists( __DIR__ . '/images/mobile-' . $image ) ) {
                    $res &= @unlink( __DIR__ . '/images/mobile-' . $image );
                }
            }
        }
